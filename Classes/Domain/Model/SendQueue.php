...
class SendQueue extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity {
	...
	/**
	 * The recipient for this send queue entry
	 *
	 * @var \DirectMailTeam\DirectMail\Domain\Model\Interfaces\Recipient
	 */
	 ...
	 * @return void
	 */
	public function setMail(\DirectMailTeam\DirectMail\Domain\Model\MailJob $mailJob) {
