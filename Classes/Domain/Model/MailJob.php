...
class MailJob extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity {
	...
	/**
	 * The "from_email" of this direct mail
	 *
	 * @var string
	 */
	protected $fromEmail = '';
	...
	/**
	 * The "from_name" of this direct mail
	 *
	 * @var string
	 */
	protected $fromName = '';
	...
	/**
	 * The "replyto_email" of this direct mail
	 *
	 * @var string
	 */
	...
	/**
	 * The "query_info" of this direct mail
	 *
	 * @var string
	 */
	protected $queryInfo = '';
	...
	/**
	 * Returns the "from_email" of this direct mail message
	 *
	 * @return string The "from_email" for this direct mail message
	 */
	...
	/**
	 * Sets the "from_email" for this direct mail message
	 *
	 * @param string $fromEmail: The "from_email" for this direct mail message
	 * @return void
	 */
	...
	/**
	 * Returns the "from_name" of this direct mail message
	 *
	 * @return string The "from_name" for this direct mail message
	 */
	...
	/**
	 * Sets the "from_name" for this direct mail message
	 *
	 * @param string $fromName: The "from_name" for this direct mail message
	 * @return void
	 */
	...
	/**
	 * Returns the "replyto_email" of this direct mail message
	 *
	 * @return string The "replyto_email" for this direct mail message
	 */
	...
	/**
	 * Sets the "replyto_email" for this direct mail message
	 *
	 * @param string $replytoEmail: The "replyto_email" for this direct mail message
	 * @return void
	 */
	...
	/**
	 * Returns the "query_info" of this direct mail message (already unserialized)
	 *
	 * @return array The "query_info" for this direct mail message
	 */
	public function getQueryInfo() {
		return unserialize($this->queryInfo);
	}

	/**
	 * Sets the "query_info" for this direct mail message
	 *
	 * @param array $queryInfo: The "query_info" for this direct mail message
	 * @return void
	 */
	public function setQueryInfo(array $queryInfo) {
		$this->queryInfo = serialize($queryInfo);
	}
